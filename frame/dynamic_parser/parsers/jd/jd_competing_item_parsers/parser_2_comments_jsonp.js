(function(){
    ...
    var _VER = '1.0.0';
    var _INDEX = 2;
    var _TYPE = 'jd:competing_comment_jsonp';
    ...
    function log(log, level){
        utils.log('{DParser JD Comment Jsonp  ' + _INDEX + '(ver:' + _VER + ')} ' + log, level);
    }
    ...
    function parseJsonp(htmlString){
        ...
        try{
            ...
            if(!rspJsonObj.CommentsCount){
                res.state = 0;
            }else{
               /* res.comment = rspJsonObj.CommentsCount; */

                var comment = rspJsonObj.CommentsCount[0];
